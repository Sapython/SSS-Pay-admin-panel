...
export class EditUserComponent implements OnInit {
  constructor(public dataProvider:DataProvider,@Inject(MAT_DIALOG_DATA) public data: any) {}
  userForm: FormGroup = new FormGroup({
    ...
    access:new FormControl(this.data?.access.access),
  ...
  userImage:any;
  ngOnInit(): void {}
  setCities(state: MatSelectChange) {
    this.filteredCities = this.stateAndCities.filter((city) => city.state === state.value);
  }
