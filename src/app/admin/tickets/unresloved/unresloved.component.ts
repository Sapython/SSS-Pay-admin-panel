...
@Component({
  selector: 'app-unresloved',
  templateUrl: './unresloved.component.html',
  styleUrls: ['./unresloved.component.scss'],
})
export class UnreslovedComponent implements OnInit, OnDestroy {
  items: Ticket[] = [];
  constructor(
  ...
  ngOnInit(): void {
    this.databaseService.getTickets('unresolved').subscribe((data: any) => {
      this.items = [];
